...
import formDetailInfoRaw from "./GoodsRegistForm.json";
...
// 조회 조건 폼 설정
const SEARCH_FORM = [
  { label: "상품구분", key: "goodsGbn", type: "multiple", codeKey: "goodsGbnData" },
  { label: "브랜드", key: "brandId", type: "select", codeKey: "brandData" },
  ...
  { label: "상품명", key: "goodsNm", type: "input", isEnterEvent: true },
...
const COLUMN_GROUPS = [
  ...
  { headerName: '브랜드명', field: 'brandNm', width: 200, cellClass: 'text-left', tooltipValueGetter: (params) => `${params.value}`, spanRows: true, },
  { headerName: '상품명', field: 'goodsNm', width: 200, cellClass: 'text-left', tooltipValueGetter: (params) => `${params.value}`, spanRows: true, },
  { headerName: '상품코드', field: 'goodsIdBrand', width: 150, cellClass: 'text-center', tooltipValueGetter: (params) => `${params.value}`, spanRows: true, },
  { headerName: '대분류명', field: 'btypeGbnNm', width: 120, cellClass: 'text-left', tooltipValueGetter: (params) => `${params.value}`, spanRows: true, },
  { headerName: '중분류명', field: 'mtypeGbnNm', width: 120, cellClass: 'text-left', tooltipValueGetter: (params) => `${params.value}`, spanRows: true, },
  { headerName: '소분류명', field: 'stypeGbnNm', width: 120, cellClass: 'text-left', tooltipValueGetter: (params) => `${params.value}`, spanRows: true, },
  { headerName: '등록일자', field: 'openD', width: 120, cellClass: 'text-center', hide: false, sortable: false }, // 히든 처리하지만 데이터 보유
  { headerName: '종료일자', field: 'closeD', width: 120, cellClass: 'text-center', tooltipValueGetter: (params) => `${params.value}`, }, // 히든 처리하지만 데이터 보유
  { headerName: '상품고유키', field: 'goodsId', width: 120, cellClass: 'text-right', hide: true, tooltipValueGetter: (params) => `${params.value}`, },
  // {
  //   headerName: "작업",
  //   field: "action",
  //   cellRenderer: (params) => {
...
// ----------------------------------------------------
export default React.memo(GoodsRegist);
