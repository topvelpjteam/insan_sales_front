/*********************************************************************
 * 화면명: 매장별 기간별 고객수 현황
 * 파일명: AgentPeriodCustCnt.jsx
 * 경로: /insanga/customer/agentperiodcustcnt
 *
 * VB6.0 화면: frm_SK543_Q
 * 프로시저: USP_SK543_Q
 *
 * [프로시저 상태: 확인 필요]
 * - 현재 USP_SK543_Q는 매장 목록(AGENT_ID, AGENT_NM)만 반환
        ...
        <div className="content-center-panel" style={{ width: "100%", padding: "20px" }}>
          <div style={{
            ...
            <div style={{ fontSize: "14px", color: "#666", textAlign: "center", lineHeight: "1.8" }}>
              <div>프로시저 확인이 필요합니다.</div>
              <div style={{ marginTop: "8px", padding: "12px", backgroundColor: "#fff3cd", borderRadius: "4px", color: "#856404" }}>
                USP_SK543_Q 프로시저가 매장 목록만 반환하고 있습니다.<br/>
                VB6.0 원본에서는 정상 작동하나, PDF 스크린샷만으로는 실제 프로시저 확인 불가.<br/>
                VB6.0 소스코드 또는 추가 문서 확인이 필요합니다.
              </div>
            </div>
          </div>
        </div>
...
export default React.memo(AgentPeriodCustCnt);
