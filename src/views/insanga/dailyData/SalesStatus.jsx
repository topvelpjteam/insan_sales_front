...
const SalesStatus = ({ tabKey }) => {
  ...
  const [goodsSearchEventModal, setGoodsSearchEventModal] = useState({ visible: false, id: null, row: {} });
  ...
  const SEARCH_FORM = [
    ...
    { label: "주문구분(F)", key: "sioId", type: "select", codeKey: "sioIdData", defaultValue: "210" },
    { label: "주문구분(T)", key: "eioId", type: "select", codeKey: "eioIdData", defaultValue: "720" },
    { label: "고객명", key: "custNm", type: "input", codeKey: "", isEnterEvent: true },
    { label: "LOT No.", key: "lotNo", type: "input", codeKey: "", isEnterEvent: true },
    ...
    { label: "매출구분", key: "pGbn", type: "radio", codeKey: "saleGbnData", defaultValue: "OFF" },
  ];
  ...
  const fetchData = useCallback(
    ...
    [filters, request, agentId, user?.emplNo, showLoading, hideLoading, showMessageModal]
  );
  ...
  // 상품 모달 창 닫기
  const handleGoodsSearchEventClose = useCallback(() => {
    setGoodsSearchEventModal({ visible: false, id: '', row: {} });
  }, []);
      ...
      <div className="content-main-area">
        ...
        <div className="content-center-panel" style={{ width: `100%` }}>
          ...
          <LeftPanel
            ...
            title={`일간 판매 현황`}
          />
          {/* <div className="content-panel-title content-panel-title-bg">일간 판매 현황</div> */}
          ...
          {/* 프로모션 상품검색 모달 */}
          {goodsSearchEventModal.visible && (
            <FrameModal title="프로모션 상품 검색"
              width="1024px"
              height="768px"
              closeOnOverlayClick={false}
              onClose={handleGoodsSearchEventClose}>
              <GoodsSearchEvent onGoodsSelected={handleGoodsSelected} />
            </FrameModal>
          )}
        </div>
      </div>
